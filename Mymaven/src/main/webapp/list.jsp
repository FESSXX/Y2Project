				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="../img/1554651606344 (2).jpg" class="user-image" alt="User Image">
							<span class="hidden-xs">Noa</span>
						</a>
						<ul class="dropdown-menu">
							<!-- User image -->
							<li class="user-header">
								<img src="../img/1554651606344 (2).jpg" class="img-circle" alt="User Image">
									...
									<c:forEach items="${list}" var="ls">
										...
										<c:forEach items="${list3}" var="i3">
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="update()">修改</button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>客户名称：<input type="text" size="50" placeholder="客户名称" value=""></p>
									<p>客户来源：<select class="control-label" style="width: 371px; height: 26px;">
										<option>电子商务</option>
									...
									<p>
										所属行业：<select  class="control-label" style="width: 371px;height: 26px;">
										<option>电子商务</option>
										<option>option 2</option>
										<option>option 3</option>
										<option>option 4</option>
									...
									<p>
										客户级别：<select class="control-label" style="width: 371px;height: 26px;">
										<option>普通客户</option>
										<option>option 2</option>
										<option>option 3</option>
										<option>option 4</option>
									...
									<p>&nbsp;&nbsp;&nbsp;联系人：<input type="text" size="50" placeholder="联系人" value=""></p>
									<p>固定电话：<input type="text" size="50" placeholder="固定电话" value=""></p>
									<p>移动电话：<input type="text" size="50" placeholder="移动电话" value=""></p>
									<p>邮政编码'：<input type="text" size="50" placeholder="邮政编码" value=""></p>
									<p>练习地址：<input type="text" size="50" placeholder="联系地址" value=""></p>
								</div>
